...
export function MissionSection({ dict }: MissionSectionProps) {
  return (
    <section id="mission" className="py-20 sm:py-28 bg-gradient-to-b from-lime-50 to-white">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden group">
            <CardContent className="p-8">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-lime-500 text-white mb-6 group-hover:scale-110 transition-transform">
          ...
          <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden group">
            <CardContent className="p-8">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-pink-400 text-white mb-6 group-hover:scale-110 transition-transform">
